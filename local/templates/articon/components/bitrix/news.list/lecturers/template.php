...
<?if (!empty($arResult['ITEMS'])):?>
    <section class="section-lecturers">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="s-lecturers-top-block">
                        <div class="row">
                            <div class="col-12 col-lg-4 col-xxl-3">
                                <div class="s-lecturers-top-left">
                                    <div class="section-title-block">
                                        <div class="section-title-label-wrapper">
                                            <div class="section-title-label">
                                                <?=GetMessage('NEWS_LIST_LECTURERS_PAGE_TOP_HEADING')?>
                                            </div>
                            ...
                            <?if (strlen($arResult['DESCRIPTION'])):?>
                                <div class="col-12 col-lg-8 col-xxl-9">
                                    <div class="s-lecturers-top-right">
                                        <div class="s-lecturers-top-text">
